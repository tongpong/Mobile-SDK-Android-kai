...
import com.dji.sdk.sample.demo.mobileremotecontroller.MobileInstructionRemoteControllerView;
...
public class DemoListView extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        builder.addGroup(R.string.component_listview_remote_controller,
                         ...
                         new GroupItem(R.string.component_listview_mobile_insturction_remote_controller,
                                       MobileInstructionRemoteControllerView.class));
